...
public class MessageMultiDataSectionImpl implements ProtonJMessage {
    ...
    public MessageMultiDataSectionImpl() {
    }

    public MessageMultiDataSectionImpl(Header header, DeliveryAnnotations deliveryAnnotations, MessageAnnotations messageAnnotations, Properties properties, ApplicationProperties applicationProperties, Section body, Footer footer) {
            this._header = header;
