...
public final class ServiceBusReceivedMessage {
     ...
     */
    public static ServiceBusReceivedMessage fromValueData(Object value) {
        if (value == null) {
            throw new IllegalArgumentException("Value data is null.");
        }

        ServiceBusReceivedMessage message = new ServiceBusReceivedMessage();
        message.bodyType = MessageBodyType.VALUE;
        message.valueData = value;
        message.sequenceData = null;
     ...
     */
    public static ServiceBusReceivedMessage fromSequenceData(List<List<Object>> sequenceData) {
        ...
        ServiceBusReceivedMessage message = new ServiceBusReceivedMessage();
        message.bodyType = MessageBodyType.SEQUENCE;
        message.valueData = null;
        message.sequenceData = sequenceData;
        message.binaryData = null;
        return message;
    }
     ...
     */
    public static ServiceBusReceivedMessage fromBinaryData(List<byte[]> binaryData) {
        ...
        ServiceBusReceivedMessage message = new ServiceBusReceivedMessage();
        message.bodyType = MessageBodyType.BINARY;
        message.valueData = null;
        message.sequenceData = null;
