...
public class MultiDataSectionDecoderImpl extends DecoderImpl implements ByteBufferDecoder
{
    ...
    public MultiDataSectionDecoderImpl()
    {
    }

    MultiDataSectionDecoderImpl(final ByteBuffer buffer)
    {
        ...
        if(code == EncodingCodes.DESCRIBED_TYPE_INDICATOR)
        {
            ...
            if(dtc == null)
            {
                dtc = new DescribedTypeConstructor()
                {
                    ...
                    {
                        return new MultiDataSectionDecoderImpl.UnknownDescribedType(descriptor, described);
                    }

                    @Override
                    public Class<?> getTypeClass()
                    {
                        return MultiDataSectionDecoderImpl.UnknownDescribedType.class;
                    }
                };
    ...
    @Override
    public <T> void readList(final Decoder.ListProcessor<T> processor)
    {
        //TODO.
    }
    ...
    <V> V readRaw(MultiDataSectionDecoderImpl.TypeDecoder<V> decoder, int size)
    {
    ...
    {
        V decode(MultiDataSectionDecoderImpl decoder, ReadableBuffer buf);
    }
